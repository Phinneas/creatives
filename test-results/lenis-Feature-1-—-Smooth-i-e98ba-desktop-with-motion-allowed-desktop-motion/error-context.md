...
- Name: lenis.spec.ts >> Feature 1 — Smooth inertial scrolling >> Lenis initializes on desktop with motion allowed
- Location: tests/motion/lenis.spec.ts:5:3
